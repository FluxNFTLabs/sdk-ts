...
export function updateModeFromJSON(object: any): UpdateMode {
  switch (object) {
    case 0:
    case "SET":
    ...
    case 1:
    case "DIFF":
      return UpdateMode.DIFF;
    case -1:
    case "UNRECOGNIZED":
    default:
      return UpdateMode.UNRECOGNIZED;
  }
}

export function updateModeToJSON(object: UpdateMode): string {
  switch (object) {
    case UpdateMode.SET:
      return "SET";
    case UpdateMode.DIFF:
      return "DIFF";
    case UpdateMode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const BalanceUpdate = {
  ...
  fromJSON(object: any): BalanceUpdate {
    return {
      ...
      mode: isSet(object.mode) ? updateModeFromJSON(object.mode) : 0,
    };
  },
  ...
  toJSON(message: BalanceUpdate): unknown {
    ...
    if (message.mode !== undefined) {
      obj.mode = updateModeToJSON(message.mode);
    }
    return obj;
  },
