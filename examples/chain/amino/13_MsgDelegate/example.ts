...
const main = async () => {
  ...
  // init msg
  const msg: stakingTypes.MsgDelegate = {
  ...
  const msgAny: anytypes.Any = {
    type_url: `/${stakingTypes.MsgDelegate.$type}`,
    value: stakingTypes.MsgDelegate.encode(msg).finish()
  }
  const msgJSON = {
    type: codectypemap[`/${stakingTypes.MsgDelegate.$type}`],
    value: stakingTypes.MsgDelegate.toJSON(msg)
  }
