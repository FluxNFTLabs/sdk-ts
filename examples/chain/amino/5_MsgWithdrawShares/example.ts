...
const main = async () => {
  ...
  // init msg
  const msg: fnfttypes.MsgWithdrawShares = {
    class_id: 'series',
    id: '0',
    sender: senderAddr,
    shares: '500',
  ...
  const msgAny: anytypes.Any = {
    type_url: `/${fnfttypes.MsgWithdrawShares.$type}`,
    value: fnfttypes.MsgWithdrawShares.encode(msg).finish(),
  }
  const msgJSON = {
    type: codectypemap[`/${fnfttypes.MsgWithdrawShares.$type}`],
    value: fnfttypes.MsgWithdrawShares.toJSON(msg)
  }
